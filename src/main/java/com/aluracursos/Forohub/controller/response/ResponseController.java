package com.aluracursos.Forohub.controller.response;

import com.aluracursos.Forohub.domain.response.DTO.ResponseDataList;
import com.aluracursos.Forohub.domain.response.DTO.ResponseDataResponse;
import com.aluracursos.Forohub.domain.response.DTO.ResponseDataUpdate;
import com.aluracursos.Forohub.domain.response.DTO.ResponseRegistrationData;
import com.aluracursos.Forohub.domain.response.Response;
import com.aluracursos.Forohub.domain.response.ResponseRepository;
